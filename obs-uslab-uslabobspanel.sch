...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabObsPanel">
    ...
    <sch:rule context="f:USLabObsPanel">
            <sch:assert test="count(f:related) &gt;= 1">related: minimum cardinality is 1</sch:assert>
    </sch:rule>
    </sch:pattern>
  <sch:pattern>
    <sch:title>Observation.extension</sch:title>
    <sch:rule context="f:USLabObsPanel/f:extension">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabObsPanel/f:code">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:USLabObsPanel/f:code">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabObsPanel/f:code/f:coding">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:USLabObsPanel/f:code/f:coding">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabObsPanel/f:identifier">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:USLabObsPanel/f:identifier">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabObsPanel/f:related">
