...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabPerformingLab">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabPerformingLab/f:identifier">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabPerformingLab/f:address">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:USLabPerformingLab/f:address">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:USLabPerformingLab/f:contact/f:name">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:USLabPerformingLab/f:contact/f:name">
            <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality is 1</sch:assert>
