...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:code">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:code/f:coding">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:code/f:coding">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:interpretation">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:interpretation">
            <sch:assert test="count(f:coding) &gt;= 1">coding: minimum cardinality is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:interpretation/f:coding">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:interpretation/f:coding">
            <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:identifier">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:identifier">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:low">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:low">
            <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:high">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:high">
            <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:age">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:age">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:age/f:low">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:age/f:low">
            <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:age/f:high">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsQuantity/f:referenceRange/f:age/f:high">
            <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality is 1</sch:assert>
