...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:stdqty/f:valueQuantity">
            <sch:assert test="count(f:value) &gt;= 1">value: minimum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:stdqty/f:valueQuantity">
            <sch:assert test="count(f:units) &gt;= 1">units: minimum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:stdqty/f:valueQuantity">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:stdqty/f:referenceRange">
