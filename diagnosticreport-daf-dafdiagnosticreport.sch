...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFDiagnosticReport">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFDiagnosticReport/f:code">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFDiagnosticReport/f:code/f:coding">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFDiagnosticReport/f:code/f:coding">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFDiagnosticReport/f:identifier">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFDiagnosticReport/f:identifier">
