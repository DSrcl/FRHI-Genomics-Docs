...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsOther">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsOther/f:code">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsOther/f:code/f:coding">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsOther/f:code/f:coding">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsOther/f:interpretation">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsOther/f:interpretation">
            <sch:assert test="count(f:coding) &gt;= 1">coding: minimum cardinality is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsOther/f:interpretation/f:coding">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsOther/f:interpretation/f:coding">
            <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DAFResultObsOther/f:identifier">
            <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality is 1</sch:assert>
    </sch:rule>
    <sch:rule context="f:DAFResultObsOther/f:identifier">
